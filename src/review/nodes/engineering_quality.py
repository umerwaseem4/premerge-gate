"""Engineering quality review node."""
...
SYSTEM_PROMPT = """You are a senior engineer reviewing code for engineering quality.
...
Severity guide:
- BLOCKING: Performance issues that will break in production (N+1, unbounded queries)
- NON_BLOCKING: Quality issues that should be addressed
...
async def engineering_quality_review(state: ReviewState, llm: ChatOpenAI) -> Dict:
    ...
    user_message = f"""
Review this code diff for engineering quality:
